...
* @{
*/
#define PRODUCT_KEY "3794d752dab740c69502b1e7986923ea"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "8d69ced667cb4391b87abcb596e5f903"
...
#define temp_value_ADDITION                      20
#define temp_value_MIN                           0
#define temp_value_MAX                           30
#define temp_value_LEN                           1
#define voltageValue_RATIO                         0.5
#define voltageValue_ADDITION                      1
#define voltageValue_MIN                           0
#define voltageValue_MAX                           8
#define voltageValue_LEN                           1
#define pv_currentValue_RATIO                         5
#define pv_currentValue_ADDITION                      10
#define pv_currentValue_MIN                           0
#define pv_currentValue_MAX                           12
#define pv_currentValue_LEN                           1
#define temp_RATIO                         0.1
#define temp_ADDITION                      0
#define temp_MIN                           0
#define temp_MAX                           1000
#define temp_LEN                           2
#define pv_voltage_RATIO                         0.01
#define pv_voltage_ADDITION                      0
#define pv_voltage_MIN                           0
#define pv_voltage_MAX                           1000
#define pv_voltage_LEN                           2
#define pv_efficiency_RATIO                         0.1
#define pv_efficiency_ADDITION                      0
#define pv_efficiency_MIN                           0
#define pv_efficiency_MAX                           1000
#define pv_efficiency_LEN                           2
#define pv_power_RATIO                         0.001
#define pv_power_ADDITION                      0
#define pv_power_MIN                           0
#define pv_power_MAX                           100000
#define pv_power_LEN                           4
...
typedef struct {
    ...
    float valuevoltageValue;
    uint32_t valuepv_currentValue;
    float valuetemp;
    float valuepv_voltage;
    float valuepv_efficiency;
    float valuepv_power;
} dataPoint_t;
...
typedef struct {
    ...
    uint8_t flagvoltageValue:1;
    uint8_t flagpv_currentValue:1;
    uint8_t flagtemp:1;
    uint8_t flagpv_voltage:1;
    uint8_t flagpv_efficiency:1;
    uint8_t flagpv_power:1;
} dataPointFlags_t;
...
typedef struct {
    ...
    uint8_t valuevoltageValue;
    uint8_t valuepv_currentValue;
    uint16_t valuetemp;
    uint16_t valuepv_voltage;
    uint16_t valuepv_efficiency;
    uint32_t valuepv_power;
} devStatus_t;
