...
int8_t gizwitsEventProcess(eventInfo_t *info, uint8_t *gizdata, uint32_t len)
{
    ...
    for(i=0; i<info->num; i++)
    {
        ...
        case EVENT_voltageValue:
            ...
            GIZWITS_LOG("Evt:EVENT_voltageValue %4f\n",currentDataPoint.valuevoltageValue);
            //user handle
            break;
        case EVENT_pv_currentValue:
            currentDataPoint.valuepv_currentValue = dataPointPtr->valuepv_currentValue;
            GIZWITS_LOG("Evt:EVENT_pv_currentValue %d\n",currentDataPoint.valuepv_currentValue);
            //user handle
            break;
...
void userHandle(void)
{
 /*
    ...
    currentDataPoint.valuepv_voltage = ;//Add Sensor Data Collection
    currentDataPoint.valuepv_efficiency = ;//Add Sensor Data Collection
    currentDataPoint.valuepv_power = ;//Add Sensor Data Collection
...
void userInit(void)
{
    ...
    currentDataPoint.valuepv_voltage = ;
    currentDataPoint.valuepv_efficiency = ;
    currentDataPoint.valuepv_power = ;
    */
